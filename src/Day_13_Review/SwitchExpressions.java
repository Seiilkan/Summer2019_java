...
public class SwitchExpressions {
	...
	/* For Switch expression we can Not use digits and letter at the same time
	 * It should be single value
	 * We can not use Double = 10F, or Float = 5F, Long = 5L....Boolean
	 * 
	 * ONLY data type, String, byte, int, short, char
	 * 
	 * We can not use || or logic, but can use multiple case blocks
	 * 
	 *//*
